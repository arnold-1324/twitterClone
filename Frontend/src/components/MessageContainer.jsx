	...
	return (
	  ...
	  >
		...
		<Flex
		  ...
		  my={4}
		  p={2}
		  height="calc(400px - 2rem)"  // Adjust this to make sure the height is properly constrained
		  overflowY="auto"
			...
			: messages.map((message) => {
				...
				return (
				  <MotionFlex
					...
					animate={{ opacity: 1, scale: 1 }}
					transition={{ duration: 0.3 }}
					position="relative" // Ensure that the three-dot menu can be positioned inside the message box
				  >
